package com.ApiProject.servelt;
import ZapposSrc.*;
...
public class Servlets2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ApiConnect apiobject = new ApiConnect(Integer.valueOf(request.getParameter("num")).intValue(),Double.valueOf(request.getParameter("sum")).doubleValue(),out); 
		apiobject.main();
